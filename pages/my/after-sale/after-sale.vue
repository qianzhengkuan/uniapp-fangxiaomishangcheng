<template>
	<view>
		<divider></divider>
		<card headTitle="申请售后的产品" style="background:#ffffff;">
		...
		<divider></divider>
		<card headTitle="服务类型" bodyPadding style="background:#ffffff;">
			<zcm-radio-group :label="label1" 
			:selected.sync='label1.selected'
			></zcm-radio-group>
		</card>
		<divider></divider>
		<card headTitle="问题描述" bodyPadding  style="background:#ffffff;" :headBorderBottom="false">
			<view class="position-relative mx-2 ">
