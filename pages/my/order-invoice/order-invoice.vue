<template>
	<view>
		...
		<card headTitle="发票类型" bodyPadding cardStyle="background:#ffffff;">
			<zmcRadioGroup :label="label1" :selected.sync="label1.selected"></zmcRadioGroup>
			<view class="text-light-muted line-h-md px-2">电子发票与纸质发票具有相同的法律效力，可作为报销、售后、维权凭证，推荐使用电子发票，不怕丢失，更方便，环保。</view>
		</card>
		<divider></divider>
		<card headTitle="发票抬头" bodyPadding cardStyle="background:#ffffff;"><zmcRadioGroup :label="label2" :selected.sync="label2.selected"></zmcRadioGroup></card>
		<divider></divider>
...
import zmcRadioGroup from '../../../components/common/radio-group.vue';
export default {
	components: {
		card,
		zmcRadioGroup
